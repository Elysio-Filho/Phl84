...
function DrawGraphH(bg){
    ...
    h=heTop;
    for (i=yMax; i >= yMin; i-=yStep){
        d.writeln('<tr><td height=' + h + '><img src=/phl84/img/024.gif border=0></td></tr>');
        h=step + ' class=gridleft';
    }

    d.writeln('<tr><td height=' + heAxis + ' class=gridleft><img src=/phl84/img/024.gif border=0></td></tr>');
    d.writeln('<tr><td height=' + heX + '><img src=/phl84/img/024.gif border=0></td></tr>');
    d.writeln('</table>');
    d.writeln('</td>');
    ...
    for (var x=0; x < bg.xValues.length; x++){
        ...
        d.writeln('<tr><td valign=bottom align=center height=' + (heTop + h) + ' class=xyvalue>'
                    + (bg.showValues ? v : '<img src=/phl84/img/024.gif border=0>') + '</td></tr>');
        h = he - h;
        d.writeln('<tr><td height=' + h + ' align=center>');
        d.write('<table width="50%" cellspacing=0 cellpadding=0 ' + ((bg.showBar) ? 'class=bar' : '') + ' id=bar>');
        d.writeln('<tr><td height=' + h + '><img src=/phl84/img/024.gif border=0></td></tr></table></td></tr>');
        d.writeln('<tr><td height=' + heAxis + ' class=gridbottom><img src=/phl84/img/024.gif border=0></td></tr>');
...
function DrawGraphV(bg){
    ...
    for (var x=0; x < bg.xValues.length; x++){
        ...
        d.writeln('<td height=' + bg.xWidth + ' class=gridleft><img src=/phl84/img/024.gif border=0 width=5></td>');
        ...
        if (isIE){
            ...
            for (i=yMin; i < yMax; i+=yStep) d.writeln('<td><img src=/phl84/img/024.gif border=0 height=' + bg.xWidth + ' width=' + step + ' class=' + g + '></td>');
            d.writeln('</tr></table>');
        }

        d.writeln('<table cellpadding=0 cellspacing=0 border=0 class=datatable>');
        d.writeln('<tr><td id=bar' + ((bg.showBar) ? ' class=bar' : '') + '><img src=/phl84/img/024.gif border=0 height=' + (bg.xWidth/2) + ' width=' + Math.ceil(v*ratio) + '>');
    ...
    d.writeln('<td height=5 class=gridleft><img src=/phl84/img/024.gif border=0 width=5></td>');
    d.writeln('<td height=5 valign=top align=left style="position:relative">');

    d.writeln('<table cellspacing=0 cellpadding=0 border=0 class=gridtable><tr>');
    for (i=yMin; i < yMax; i+=yStep) d.writeln('<td align=left class=gridbottom><img src=/phl84/img/024.gif border=0 height=5 width=' + step + ' ></td>');
    d.writeln('</tr></table></td></tr>');

    d.writeln('<tr><td></td><td></td>');
    d.writeln('<td valign=top align=left style="position:relative">');
    d.writeln('<table cellspacing=0 cellpadding=0 border=0 class=gridtable><tr>');
    for (i=yMin; i <= yMax; i+=yStep) d.writeln('<td align=left valign=top class=yvalue>' + i + '<br><img src=/phl84/img/024.gif border=0 height=1 width=' + step + ' ></td>');
    d.writeln('</tr></table></td></tr>');
